...
/*
Bazı threadlerin, main thread ve diğer threadlerden önce çalışıp işini tamamladıktan sonra
diğer threadlerin kaldığı yerden devam etmesini istediğimizde "CountDownLatch" classının
methodları ile öncelik vermek izediğimiz threadlerin sayısı kadar bir sayaç başlatıp sayaç
 0 olana kadar diğer threadler bekletilecektir.
...
public class CountDownLatch01_Gün06 {
